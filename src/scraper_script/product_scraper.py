...
class WebScraper:
    ...
    def _scrape_product_data(self, link):
        try:
            ...
            product_soup = self._get_soup(link)
            ...
            logging.error(f'Error occurred : {CustomException(e, sys)}')
    ...
    def scrape(self):
        try:
            ...
            self.pcComponents_url_list = list(
                dict.fromkeys(self.pcComponents_url_list))
